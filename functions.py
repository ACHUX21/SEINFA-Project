...
def insert_ToLigne(client, devis, ar_ref, productDescription, quantity, price, dateF, ref, date, total):
    try:
        ...
        cursor.execute(query, (0,0,client,devis,"","",date,dateF,dateF,1000,ref,0,0,0,ar_ref,productDescription,quantity,0.000000,0.000000,0.000000,0.000000,0.000000,1,0.000000,0,0.000000,0,price,0.000000,19,0,0,0.000000,6.000000,0,0,"Unit̩",quantity,0,1,1,0,0.000000,price*1.2,dateF,"",0.000000,1,"",0,"",total,total*1.2,0,0,"",dateF,0.000000,"",0,0,dateF,"",0,"",date,1.000000,"",0,0,0))
        cursor.commit()
        cursor.close()
